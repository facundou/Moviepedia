...
class Show extends Command
{
    public function configure()
    {
        $this->setName('Show')
            ...
            ->addOption('fullplot', null, InputOption::VALUE_NONE, 'Plot completo');
    }
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if($input->getOption('fullplot') != null){
            $response = $client->request('GET', "?apikey=58d24874&t=$title&plot=full");
